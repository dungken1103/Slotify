...
export function BookingPage() {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      alert(error.response?.data?.message || "Đã xảy ra lỗi trong quá trình đặt vé");
    } finally {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl font-medium">Đang tải sơ đồ ghế...</p>
        </div>
      </div>
    );
  }
  ...
  if (!showtime) {
    return <div className="min-h-screen flex items-center justify-center bg-background text-xl">Không tìm thấy lịch chiếu</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col lg:flex-row">
      ...
      <div className="flex-1 p-6 lg:p-10 flex flex-col relative">
        ...
        <div className="flex-1 flex flex-col items-center justify-center min-h-[500px]">
          ...
          <div className="w-2/3 h-2 bg-gradient-to-r from-transparent via-primary/50 to-transparent mb-12 relative">
             <div className="absolute top-4 left-1/2 -translate-x-1/2 text-xs text-muted-foreground uppercase tracking-[0.2em]">Màn hình</div>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
             ...
             <div className="flex items-center gap-2">
                <div className="w-8 h-4 rounded bg-pink-500/20 border border-pink-500/50"></div> Ghế đôi
             </div>
             <div className="flex items-center gap-2">
      ...
      <div className="w-full lg:w-96 border-l border-border/50 bg-card p-8 flex flex-col shadow-2xl">
         <h2 className="text-2xl font-bold mb-6">Thông tin đặt vé</h2>
         ...
         <div className="space-y-6 flex-1">
            ...
            <div className="border-t border-border/50 pt-4">
                <div className="flex justify-between items-center mb-2 text-sm">
                  <span className="text-muted-foreground">Thuế (Đã bao gồm)</span>
